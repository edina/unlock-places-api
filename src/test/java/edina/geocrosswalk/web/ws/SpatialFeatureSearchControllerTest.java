...
/**
 * Test cases for <code>SpatialFeatureSearchController</code>.
 * 
 * @author Joe Vernon
 */
public class SpatialFeatureSearchControllerTest {

	private SpatialFeatureSearchController controller;
    ...
    private String featureType = "hotel";
	...
	public void onSetUp() {
		...
		controller = new SpatialFeatureSearchController();
		...
		errors = new BindException(command, "spatialFeatureSearchCommand");
	...
	public void testHandle() throws Exception {
		...
		assertEquals(command.getBoundingBox(), boundingBox);
		...
		expect(mockSpatialService.getFeaturesForFeatureTypeAndBBox(featureType, boundingBox, operator, 0, 10, null, count, country, srs, srs_in, searchVariants, deepSrc)).andReturn(
				result).once();
