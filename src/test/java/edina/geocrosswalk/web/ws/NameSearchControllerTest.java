...
/**
 * Test cases for <code>NameSearchController</code>.
 * 
 * @author Brian O'Hare
 * @author Joe Vernon
 * 
...
public class NameSearchControllerTest {
	...
	public void onSetUp() {
		...
		controller = new NameSearchController();
		command = new NameSearchCommand();
	...
	public void testHandle() throws Exception {
		...
		expect(mockSpatialService.getFeaturesForName(name, 0, 10, gazetteer, count, country, srs, null, null)).andReturn(result).once();
