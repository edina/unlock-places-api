...
/**
 * Test cases for {@link NameStartsWithSearchCommandValidator}.
 * 
 * @author Joe Vernon
 * 
 */

public class FullTextNameSearchCommandValidatorTest {

	private static Logger logger = Logger.getLogger(NameStartsWithSearchCommandValidator.class);
	...
	NameStartsWithSearchCommandValidator commandValidator;
	...
	public void setUp() throws Exception {
		commandValidator = new NameStartsWithSearchCommandValidator();
	...
	public void testSupports() {
		assertTrue(commandValidator.supports(NameStartsWithSearchCommand.class));
	}
