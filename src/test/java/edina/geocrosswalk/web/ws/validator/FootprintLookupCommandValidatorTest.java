...
/**
 * Test cases for {@link FootprintLookupCommandValidator}.
 * 
 * @author Brian O'Hare
 * 
 */
public class FootprintLookupCommandValidatorTest {
	...
	FootprintLookupCommand command;
	FootprintLookupCommandValidator commandValidator;
	...
	public void onSetUp() {
		...
		commandValidator = new FootprintLookupCommandValidator();
