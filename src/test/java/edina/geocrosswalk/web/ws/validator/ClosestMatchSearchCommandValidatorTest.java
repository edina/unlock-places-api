...
/**
 * Test cases for {@link ClosestMatchSearchCommandValidator}.
 * 
 * @author Joe Vernon
 * 
 */

public class ClosestMatchSearchCommandValidatorTest {

	private static Logger logger = Logger.getLogger(ClosestMatchSearchCommandValidator.class);
	private static final ResourceBundle resources = ResourceBundle.getBundle("config/ws");
	ClosestMatchSearchCommand searchCommand;
	ClosestMatchSearchCommandValidator commandValidator;
	...
	public void setUp() throws Exception {
		commandValidator = new ClosestMatchSearchCommandValidator();
		nameValidator = new NameValidator();
		searchCommand = new ClosestMatchSearchCommand();
	...
	public void testSupports() {
		assertTrue(commandValidator.supports(ClosestMatchSearchCommand.class));
	}
