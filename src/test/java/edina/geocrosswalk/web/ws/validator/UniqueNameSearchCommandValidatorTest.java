...
/**
 * Test cases for {@link UniqueNameSearchCommandValidator}.
 * 
 * @author Joe Vernon
 * 
 */

public class UniqueNameSearchCommandValidatorTest {
	...
	UniqueNameSearchCommand searchCommand;
	UniqueNameSearchCommandValidator commandValidator;
	...
	public void setUp() throws Exception {
		commandValidator = new UniqueNameSearchCommandValidator();
		nameValidator = new NameValidator();
		searchCommand = new UniqueNameSearchCommand();
	...
	public void testSupports() {
		assertTrue(commandValidator.supports(UniqueNameSearchCommand.class));
	}
