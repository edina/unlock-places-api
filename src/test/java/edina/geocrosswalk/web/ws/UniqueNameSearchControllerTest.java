...
/**
 * Test cases for <code>UniqueNameSearchController</code>.
 * 
 * @author Joe Vernon
 * 
 */
public class UniqueNameSearchControllerTest {

	private UniqueNameSearchController controller;
	private ISpatialService mockSpatialService;
	private IFormatProviderService mockFormatService;
	private UniqueNameSearchCommand command;
	...
	public void onSetUp() {
		...
		controller = new UniqueNameSearchController();
		command = new UniqueNameSearchCommand();
	...
	public void testHandle() throws Exception {
		...
		expect(mockSpatialService.getFeaturesForUniqueNameSearch(name, 0, 10, gazetteer, count, country, srs, searchVariants, deepSrc)).andReturn(result).once();
